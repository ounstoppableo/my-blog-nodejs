...
const uploadImg = multer({ dest: __dirname + '/../public/images/',limits: { fileSize: 1 * 1024 * 1024 } })
const uploadMusic = multer({ dest: __dirname + '/../public/music/', limits: { fileSize: 20 * 1024 * 1024 } })
const uploadFile = multer({ dest: __dirname + '/../public/temp/',limits: { fileSize: 1 * 1024 * 1024 } })
const fs = require('fs')
